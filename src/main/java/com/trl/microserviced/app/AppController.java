...
public class AppController {
    ...
    public ResponseEntity<String> post() {
        ...
        String result = String.format("(microservice-d)(PostMapping)(Application name: '%s')(Host: '%s')(Port: '%s')",
    ...
    public ResponseEntity<String> get(@PathVariable Long id) {
        ...
        InstanceInfo instanceInfo = eurekaClient.getApplication(appName).getInstances().get(0);
        String result = String.format("(microservice-d)(GetMapping)(id: '%s')(Application name: '%s')(Host: '%s')(Port: '%s')",
    ...
    public ResponseEntity<String> patch(@PathVariable Long id) {
        ...
        InstanceInfo instanceInfo = eurekaClient.getApplication(appName).getInstances().get(0);
        String result = String.format("(microservice-d)(PatchMapping)(id: '%s')(Application name: '%s')(Host: '%s')(Port: '%s')",
                id, instanceInfo.getAppName(), instanceInfo.getHostName(), instanceInfo.getPort());
    ...
    public ResponseEntity<String> delete(@PathVariable Long id) {
        ...
        InstanceInfo instanceInfo = eurekaClient.getApplication(appName).getInstances().get(0);
        String result = String.format("(microservice-d)(DeleteMapping)(id: '%s')(Application name: '%s')(Host: '%s')(Port: '%s')",
                id, instanceInfo.getAppName(), instanceInfo.getHostName(), instanceInfo.getPort());
